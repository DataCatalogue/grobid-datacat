...
public class ProcessEngineDatacat implements Closeable {
     ...
     * @throws Exception
     */
    public void createTrainingBlankBlockParsing(final GrobidDatacatMainArgs pGbdArgs) throws Exception {
        inferPdfInputPath(pGbdArgs);
        inferOutputPath(pGbdArgs);
        int result = getEngine().batchCreateTrainingBlankBlockParsing(pGbdArgs.getPath2Input(), pGbdArgs.getPath2Output(), -1);
        LOGGER.info(result + " files processed.");
    }
