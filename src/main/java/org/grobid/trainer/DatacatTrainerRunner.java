...
public class DatacatTrainerRunner {

    private static Logger LOGGER = LoggerFactory.getLogger(DatacatTrainerRunner.class);

    private static final List<String> models = Arrays.asList("datacat-segmenter");
